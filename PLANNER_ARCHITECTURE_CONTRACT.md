...
| Fight Visualisation countdown protocol (D-7/5/3/1/0) | `gap_fill_inserts.py`, `fight_visualization_library.py` | mandatory countdown layer, after gap fill | Existing on its exact D-day; selected bank entry; visible prescription | Being scored, budgeted, moved, or skipped because the day is busy or has no S&C |
