...
- Runtime guards are process-local: each API/worker process keeps its own in-memory limiter/cache state and does not share that state with other processes.
