...
## 3. The service
UNLXCK provides personalised combat-sport training and performance support. Features may include training plans, readiness check-ins, training adaptation, injury-aware exercise restrictions, nutrition/weight-management guidance, progress features and notifications.
...
- not misuse, interfere with, reverse engineer, circumvent security controls or unlawfully access the service or another user's data.
