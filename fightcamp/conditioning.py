...
CONDITIONING_GOAL_PRIORITY_SCALE = 2.5
CONDITIONING_WEAKNESS_PRIORITY_SCALE = 2.7777777778
...
def _conditioning_goal_priority_bonus(tags: list[str], priority_profile) -> float:
    scaled = total_goal_priority_bonus(tags, priority_profile) * CONDITIONING_GOAL_PRIORITY_SCALE
    return min(scaled, CONDITIONING_MAX_GOAL_PRIORITY_BONUS)


def _conditioning_weakness_priority_bonus(tags: list[str], priority_profile) -> float:
    scaled = total_weakness_priority_bonus(tags, priority_profile) * CONDITIONING_WEAKNESS_PRIORITY_SCALE
    return min(scaled, CONDITIONING_MAX_WEAKNESS_PRIORITY_BONUS)
