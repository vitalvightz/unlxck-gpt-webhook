...
STRUCTURAL_RED_FLAG_MAP: dict[str, tuple[str, ...]] = {
    ...
    # Ligament tear / rupture. Every "<verb> <ligament>" and "<ligament> <verb>"
    # order for the named knee ligaments, so word order never changes the flag.
    "acl tear": _taxonomy_flags_for("acl_tear"),
    "torn acl": _taxonomy_flags_for("acl_tear"),
    "acl torn": _taxonomy_flags_for("acl_tear"),
    "acl rupture": _taxonomy_flags_for("acl_tear"),
    "ruptured acl": _taxonomy_flags_for("acl_tear"),
    "blown acl": _taxonomy_flags_for("acl_tear"),
    "popped acl": _taxonomy_flags_for("acl_tear"),
    "acl gone": _taxonomy_flags_for("acl_tear"),
    "mcl tear": _taxonomy_flags_for("mcl_tear"),
    "torn mcl": _taxonomy_flags_for("mcl_tear"),
    "mcl torn": _taxonomy_flags_for("mcl_tear"),
    "mcl rupture": _taxonomy_flags_for("mcl_tear"),
    "ruptured mcl": _taxonomy_flags_for("mcl_tear"),
    "lcl tear": _taxonomy_flags_for("lcl_tear"),
    "torn lcl": _taxonomy_flags_for("lcl_tear"),
    "lcl torn": _taxonomy_flags_for("lcl_tear"),
    "lcl rupture": _taxonomy_flags_for("lcl_tear"),
    "ruptured lcl": _taxonomy_flags_for("lcl_tear"),
    "pcl tear": _taxonomy_flags_for("pcl_tear"),
    "torn pcl": _taxonomy_flags_for("pcl_tear"),
    "pcl torn": _taxonomy_flags_for("pcl_tear"),
    "pcl rupture": _taxonomy_flags_for("pcl_tear"),
    "ruptured pcl": _taxonomy_flags_for("pcl_tear"),
    ...
    "ligament rupture": _taxonomy_flags_for("ligament_tear"),
    "blown ligament": _taxonomy_flags_for("ligament_tear"),

    # Tendon tear / rupture, including the tendons athletes name directly
    # (achilles, biceps, rotator cuff, patellar / quad tendon).
    ...
    "torn achilles": _taxonomy_flags_for("tendon_rupture"),
    "achilles tear": _taxonomy_flags_for("tendon_rupture"),
    "achilles rupture": _taxonomy_flags_for("tendon_rupture"),
    "ruptured achilles": _taxonomy_flags_for("tendon_rupture"),
    "snapped achilles": _taxonomy_flags_for("tendon_rupture"),
    "achilles snapped": _taxonomy_flags_for("tendon_rupture"),
    "popped achilles": _taxonomy_flags_for("tendon_rupture"),
    "achilles gone": _taxonomy_flags_for("tendon_rupture"),
    "bicep tear": _taxonomy_flags_for("tendon_rupture"),
    "torn bicep": _taxonomy_flags_for("tendon_rupture"),
    "bicep rupture": _taxonomy_flags_for("tendon_rupture"),
    "ruptured bicep": _taxonomy_flags_for("tendon_rupture"),
    "rotator cuff tear": _taxonomy_flags_for("tendon_rupture"),
    "torn rotator cuff": _taxonomy_flags_for("tendon_rupture"),
    "patellar tendon rupture": _taxonomy_flags_for("tendon_rupture"),
    "quad tendon tear": _taxonomy_flags_for("tendon_rupture"),

    # Muscle tear / rupture
    "muscle rupture": _taxonomy_flags_for("muscle_rupture"),
    "muscle ruptured": _taxonomy_flags_for("muscle_rupture"),
    "muscle tear": _taxonomy_flags_for("muscle_rupture"),
    "torn muscle": _taxonomy_flags_for("muscle_rupture"),
    "tore muscle": _taxonomy_flags_for("muscle_rupture"),
    "torn hamstring": _taxonomy_flags_for("muscle_rupture"),
    "hamstring tear": _taxonomy_flags_for("muscle_rupture"),
    "torn quad": _taxonomy_flags_for("muscle_rupture"),
    "quad tear": _taxonomy_flags_for("muscle_rupture"),
    "torn calf": _taxonomy_flags_for("muscle_rupture"),
    "calf tear": _taxonomy_flags_for("muscle_rupture"),
    "torn pec": _taxonomy_flags_for("muscle_rupture"),
    "pec tear": _taxonomy_flags_for("muscle_rupture"),
    "torn groin": _taxonomy_flags_for("muscle_rupture"),
    "groin tear": _taxonomy_flags_for("muscle_rupture"),
    ...
    "blurry vision": ("structural_red_flag", "suspected_concussion", "urgent"),
    "vision blurred": ("structural_red_flag", "suspected_concussion", "urgent"),
    "vision blurry": ("structural_red_flag", "suspected_concussion", "urgent"),
    "double vision": ("structural_red_flag", "suspected_concussion", "urgent"),
    "seeing double": ("structural_red_flag", "suspected_concussion", "urgent"),
    "head spinning": ("structural_red_flag", "suspected_concussion", "urgent"),
    "head is spinning": ("structural_red_flag", "suspected_concussion", "urgent"),
    "room spinning": ("structural_red_flag", "suspected_concussion", "urgent"),
    "room is spinning": ("structural_red_flag", "suspected_concussion", "urgent"),
    "woozy": ("structural_red_flag", "suspected_concussion", "urgent"),
    "dazed": ("structural_red_flag", "suspected_concussion", "urgent"),
    "loopy": ("structural_red_flag", "suspected_concussion", "urgent"),
    "knocked loopy": ("structural_red_flag", "suspected_concussion", "urgent"),
    "punch drunk": ("structural_red_flag", "suspected_concussion", "urgent"),
}
...
TRIAGE_CATEGORY_MAP: dict[str, str] = {
    ...
    "torn acl": "acl_tear",
    "acl torn": "acl_tear",
    "acl rupture": "acl_tear",
    "ruptured acl": "acl_tear",
    "blown acl": "acl_tear",
    "popped acl": "acl_tear",
    "acl gone": "acl_tear",
    "mcl tear": "mcl_tear",
    "torn mcl": "mcl_tear",
    "mcl torn": "mcl_tear",
    "mcl rupture": "mcl_tear",
    "ruptured mcl": "mcl_tear",
    "lcl tear": "lcl_tear",
    "torn lcl": "lcl_tear",
    "lcl torn": "lcl_tear",
    "lcl rupture": "lcl_tear",
    "ruptured lcl": "lcl_tear",
    "pcl tear": "pcl_tear",
    "torn pcl": "pcl_tear",
    "pcl torn": "pcl_tear",
    "pcl rupture": "pcl_tear",
    "ruptured pcl": "pcl_tear",
    "ligament tear": "ligament_tear",
    "torn ligament": "ligament_tear",
    "ruptured ligament": "ligament_tear",
    "ligament rupture": "ligament_tear",
    ...
    "torn achilles": "tendon_rupture",
    "achilles tear": "tendon_rupture",
    "achilles rupture": "tendon_rupture",
    "ruptured achilles": "tendon_rupture",
    "snapped achilles": "tendon_rupture",
    "achilles snapped": "tendon_rupture",
    "popped achilles": "tendon_rupture",
    "achilles gone": "tendon_rupture",
    "bicep tear": "tendon_rupture",
    "torn bicep": "tendon_rupture",
    "bicep rupture": "tendon_rupture",
    "ruptured bicep": "tendon_rupture",
    "rotator cuff tear": "tendon_rupture",
    "torn rotator cuff": "tendon_rupture",
    "patellar tendon rupture": "tendon_rupture",
    "quad tendon tear": "tendon_rupture",
    "muscle rupture": "muscle_rupture",
    "muscle ruptured": "muscle_rupture",
    "muscle tear": "muscle_rupture",
    "torn muscle": "muscle_rupture",
    "tore muscle": "muscle_rupture",
    "torn hamstring": "muscle_rupture",
    "hamstring tear": "muscle_rupture",
    "torn quad": "muscle_rupture",
    "quad tear": "muscle_rupture",
    "torn calf": "muscle_rupture",
    "calf tear": "muscle_rupture",
    "torn pec": "muscle_rupture",
    "pec tear": "muscle_rupture",
    "torn groin": "muscle_rupture",
    "groin tear": "muscle_rupture",
    ...
    # Unambiguous head-trauma symptoms (see STRUCTURAL_RED_FLAG_MAP note).
    "seeing stars": "concussion",
    "saw stars": "concussion",
    "blurred vision": "concussion",
    "blurry vision": "concussion",
    "vision blurred": "concussion",
    "vision blurry": "concussion",
    "double vision": "concussion",
    "seeing double": "concussion",
    "head spinning": "concussion",
    "head is spinning": "concussion",
    "room spinning": "concussion",
    "room is spinning": "concussion",
    "woozy": "concussion",
    "dazed": "concussion",
    "loopy": "concussion",
    "knocked loopy": "concussion",
