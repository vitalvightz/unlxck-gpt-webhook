...
INJURY_TAXONOMY: dict[str, dict[str, Any]] = {
    ...
    "acl_tear": {"display": "ACL Tear", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_ligament_tear", "urgent"], "blocked_training_tags": ["contact", "sparring", "high_impact_plyo", "landing_stress_high", "reactive_rebound_high", "max_velocity", "hard_cutting", "decel_high", "knee_dominant_heavy", "deep_knee_flexion_loaded"], "blocked_rehab_terms": ["pogo", "jump", "hop", "depth", "reactive", "sprint", "cutting", "spanish squat", "step-down"], "requires_clinical_clearance": True, "red_flag_message": "Do not train this injury normally until medically cleared."},
    "ligament_tear": {"display": "Ligament Tear", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_ligament_tear", "urgent"], "blocked_training_tags": ["contact", "sparring", "hard_cutting", "decel_high", "high_impact_plyo"], "blocked_rehab_terms": ["jump", "hop", "sprint", "cutting", "depth"], "requires_clinical_clearance": True, "red_flag_message": "Suspected ligament tear requires clinical clearance before return to loading."},
    "mcl_tear": {"display": "MCL Tear", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_ligament_tear", "urgent"], "blocked_training_tags": ["contact", "sparring", "hard_cutting", "decel_high", "high_impact_plyo"], "blocked_rehab_terms": ["jump", "hop", "sprint", "cutting", "depth"], "requires_clinical_clearance": True, "red_flag_message": "Suspected ligament tear requires clinical clearance before return to loading."},
    "lcl_tear": {"display": "LCL Tear", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_ligament_tear", "urgent"], "blocked_training_tags": ["contact", "sparring", "hard_cutting", "decel_high", "high_impact_plyo"], "blocked_rehab_terms": ["jump", "hop", "sprint", "cutting", "depth"], "requires_clinical_clearance": True, "red_flag_message": "Suspected ligament tear requires clinical clearance before return to loading."},
    "pcl_tear": {"display": "PCL Tear", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_ligament_tear", "urgent"], "blocked_training_tags": ["contact", "sparring", "hard_cutting", "decel_high", "high_impact_plyo"], "blocked_rehab_terms": ["jump", "hop", "sprint", "cutting", "depth"], "requires_clinical_clearance": True, "red_flag_message": "Suspected ligament tear requires clinical clearance before return to loading."},
    "tendon_rupture": {"display": "Tendon Rupture", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_tendon_rupture", "urgent"], "blocked_training_tags": ["high_impact_plyo", "reactive_rebound_high", "max_velocity", "running_volume_high", "calf_rebound_high", "forefoot_load_high", "explosive_lower"], "blocked_rehab_terms": ["eccentric calf drops", "pogo", "hop", "jump", "sprint", "depth"], "requires_clinical_clearance": True, "red_flag_message": "Suspected tendon rupture requires medical clearance before return to loading."},
    "muscle_rupture": {"display": "Muscle Rupture", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_muscle_rupture", "urgent"], "blocked_training_tags": ["max_velocity", "explosive_lower", "hard_cutting"], "blocked_rehab_terms": ["sprint", "jump", "explosive"], "requires_clinical_clearance": True, "red_flag_message": "Suspected muscle rupture requires clinical clearance before return to high-load activity."},
    "fracture": {"display": "Fracture", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_fracture", "urgent"], "blocked_training_tags": ["contact", "sparring", "high_impact_plyo"], "blocked_rehab_terms": ["jump", "impact", "loaded"], "requires_clinical_clearance": True, "red_flag_message": "Suspected fracture requires immediate clinical assessment and clearance."},
    "dislocation": {"display": "Dislocation", "category": "structural", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_dislocation", "urgent"], "blocked_training_tags": ["contact", "sparring", "overhead", "dynamic_overhead", "press_heavy", "explosive_upper_push"], "blocked_rehab_terms": ["overhead", "press", "push press", "snatch", "jerk", "dip", "explosive"], "requires_clinical_clearance": True, "red_flag_message": "Suspected dislocation requires clinical clearance before loading or contact."},
    "concussion": {"display": "Concussion", "category": "neurological", "default_severity": "high", "urgent": True, "rehab_allowed": False, "flags": ["structural_red_flag", "suspected_concussion", "urgent"], "blocked_training_tags": ["contact", "sparring", "head_impact", "hard_contact", "live_rounds", "high_cns", "max_velocity", "explosive_conditioning"], "blocked_rehab_terms": [], "requires_clinical_clearance": True, "red_flag_message": "No contact, sparring, high-CNS conditioning, or return-to-play progression until medically cleared."},
