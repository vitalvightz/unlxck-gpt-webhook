    ...
    *,
    ...
    packet = {
        ...
        "hard_rules": [
            ...
            "Stage 1 draft exercise text is candidate material only. For a role with selected_exercise_assignments, those assignments are the deterministic planner's complete session membership: render every listed exercise and no others. Do not omit a listed exercise or add candidates, alternates, substitutes, or other S&C exercises. Final exercise rendering must obey weekly_role_map role, count, day ownership, restrictions, and taper rules first.",
