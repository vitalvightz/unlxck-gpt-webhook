...
"Hard sparring days are the athlete's own combat locks (run in their gym, with or without a coach). The app does not prescribe or lead the sparring itself, and it never deloads, caps, or drops a declared hard sparring day. At D-18 or further out render the label '" + CANONICAL_HARD_SPARRING_LABEL + "' (or the equivalent sport-specific label such as 'MMA — hard sparring / controlled hard contact'). From D-17 onward hard sparring is banned: render '" + CANONICAL_HARD_SPARRING_BAN_LABEL + "' (or sport-equivalent) — the same applies whenever the day carries reason code 'd17_hard_sparring_ban'. Do not output round counts, time-x-rounds formulas, intensity targets, dose, RPE, work:rest, or any sparring template wording (e.g. never '6-8 x 3-min rounds at set intensity', 'X rounds technical sparring', 'live rounds at moderate intensity'). After the session label, emit exactly one short note in this form: '" + CANONICAL_HARD_SPARRING_NOTE + "' Do not narrate intent, do not add a 'why today' line, do not list focus areas, do not suggest pad/bag/clinch volume — the athlete owns that contact work. Never schedule programmed S&C on a declared hard-sparring/contact day. Anything more than the label plus that one note is a violation of this rule.",
...
Hard sparring days are the athlete's own combat locks (run in their gym, with or without a coach). The app must not prescribe or lead the sparring itself, and it never deloads, caps, or drops a declared hard sparring day. At D-18 or further out render the label "Hard sparring — controlled hard contact" (or the equivalent sport-specific label such as "MMA — hard sparring / controlled hard contact"). From D-17 onward hard sparring is banned: render "Technical-only combat" (or sport-equivalent) — the same applies whenever the day carries reason code "d17_hard_sparring_ban". Do not output round counts, time-x-rounds formulas, intensity targets, dose, RPE, work:rest, or any sparring template wording. After the session label, emit exactly one short note in this form: "Your own hard sparring/contact work — no extra S&C. Keep freshness priority." Do not narrate intent, do not add a "why today" line, do not list focus areas, do not suggest pad/bag/clinch volume — the athlete owns that contact work. Never schedule programmed S&C on a declared hard-sparring/contact day. Anything more than the label plus that one note is a violation of this rule.
