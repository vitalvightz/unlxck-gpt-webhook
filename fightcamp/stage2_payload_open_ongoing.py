...
def _uses_open_ongoing_payload(athlete_model: dict[str, Any]) -> bool:
    ...
    if isinstance(no_scheduled_fight, bool) and no_scheduled_fight:
        return True
    ...
    return {
        ...
        "open_plan_spec": {
            ...
            "weekly_template": {
                ...
                "coach_owned_boxing_days": athlete_model.get("hard_sparring_days") or [],
            },
            "development_block": {
            ...
            "athlete_context": {
                ...
                "injuries": athlete_model.get("injuries"),
                "restrictions": athlete_model.get("injury_restrictions"),
                "weight_cut_pct": athlete_model.get("weight_cut_pct"),
                "goals": athlete_model.get("key_goals"),
                "weaknesses": athlete_model.get("weaknesses"),
                "equipment": athlete_model.get("equipment"),
            },
        },
    }
