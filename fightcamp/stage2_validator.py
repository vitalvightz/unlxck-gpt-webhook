...
def validate_stage2_output(*, planning_brief: dict, final_plan_text: str) -> dict:
    ...
    for block in countdown_blocks:
        ...
        if 0 <= day <= 16 and hard_spar_pattern.search(joined):
            errors.append(_issue(code="late_fight_hard_sparring_violation", message="Hard sparring appears inside D-16 to D-0.", severity="blocker", confidence="high", line=block["header"]))
