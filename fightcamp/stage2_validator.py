...
_LATE_FIGHT_WINDOW_EXERCISE_RULES: dict[str, dict[str, list[str]]] = {
    "d21_to_d14": {
        "blocked": ["hard shuttle", "bag sprint", "sprint", "sprints", "sprinting", "jump", "jumps", "jumping", "dense circuit", "eccentric"],
        "preferred": ["trap bar", "med-ball", "band jab-cross", "mobility"],
    },
    "d13_to_d8": {
        "blocked": ["olympic", "heavy trap", "trap bar", "trap-bar", "eccentric", "jump", "jumps", "jumping", "sprint", "sprints", "sprinting", "sprint start", "dense conditioning"],
        "preferred": ["med-ball", "band jab-cross", "boxing burst", "reactive shuffle", "mobility", "breathing"],
    },
    "d7": {
        "blocked": ["olympic", "heavy lower", "eccentric", "jump", "jumps", "jumping", "jump reset", "sprint", "sprints", "sprinting", "sprint start", "high-volume bag"],
        "preferred": ["band jab-cross", "reactive shuffle", "boxing burst", "technical rhythm", "mobility"],
    },
    "d6_to_d5": {
        "blocked": ["band-assisted jump reset", "band-resisted sprint start", "jump", "jumps", "jumping", "sprint", "sprints", "sprinting", "loaded strength", "dense conditioning"],
        "preferred": ["explosive boxing burst intervals", "reactive shuffle repeats", "band-resisted jab-cross primer"],
    },
    "d4_to_d2": {
        "blocked": ["loaded strength", "sprint", "sprints", "sprinting", "sprint start", "jump", "jumps", "jumping", "jump reset", "heavy bag", "med-ball", "medicine ball", "medicine-ball", "eccentric"],
        "preferred": ["technical shadowboxing", "mobility reset", "breathing", "band face pull", "light band punch", "mirror drill"],
    },
    "d1": {
        "blocked": ["med-ball", "medicine ball", "medicine-ball", "heavy bag", "pull-up", "pull up", "pull-up hold", "sprint", "sprints", "sprinting", "jump", "jumps", "jumping", "barbell", "trap bar", "trap-bar", "loaded strength", "eccentric"],
        "preferred": [
