...
insert into public.notification_templates (
  ...
  ('daily_camp_briefing', 'db-02', 'TODAY HAS A JOB.', '{session}. Know the target and keep the day clean around it.', 'en-GB', 1, true, 1),
  ('daily_camp_briefing', 'db-03', 'CAMP BRIEFING.', '{session}. That is the priority. Everything else supports it.', 'en-GB', 1, true, 1),
  ('daily_camp_briefing', 'db-04', 'TODAY''S CALL IS SET.', '{session}. Open Today when you are ready to see the full brief.', 'en-GB', 1, true, 1),
  ('session_preparation', 'sp-01', 'GET READY FOR THE WORK.', 'Fuel, hydrate and get your head on {session}. Training is later.', 'en-GB', 1, true, 1),
