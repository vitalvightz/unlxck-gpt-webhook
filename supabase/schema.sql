...
create policy "profiles_self_or_admin_select" on public.profiles for
select
  using (
    auth.uid () = id
    or public.is_admin ()
...
drop policy if exists "athlete_intakes_self_or_admin_select" on public.athlete_intakes;


create policy "athlete_intakes_self_or_admin_select" on public.athlete_intakes for
select
  using (
    athlete_id = auth.uid ()
    or public.is_admin ()
...
create policy "athlete_intakes_self_or_admin_insert" on public.athlete_intakes for insert
with
  check (
    athlete_id = auth.uid ()
    or public.is_admin ()
...
create policy "athlete_intakes_self_or_admin_update" on public.athlete_intakes
for update
  using (
    athlete_id = auth.uid ()
    or public.is_admin ()
...
create policy "plans_self_or_admin_select" on public.plans for
select
  using (
    athlete_id = auth.uid ()
    or public.is_admin ()
...
create policy "plans_self_or_admin_insert" on public.plans for insert
with
  check (
    athlete_id = auth.uid ()
    or public.is_admin ()
