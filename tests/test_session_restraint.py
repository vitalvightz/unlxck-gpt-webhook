...
def test_exact_band_boundary_is_included_in_leader_group():
    ordered = sort_weighted_candidates(
        [
            {"name": "Leader", "score": 10.0, "fatigue_cost": 4},
            {"name": "Boundary", "score": 9.8, "fatigue_cost": 1},
        ],
...
def test_just_outside_band_starts_a_new_group():
    ordered = sort_weighted_candidates(
        [
            {"name": "Leader", "score": 10.0, "fatigue_cost": 4},
            {"name": "Outside", "score": 9.79, "fatigue_cost": 0},
        ],
        near_equal_score_band=0.2,
    )
...
def test_grouping_is_leader_anchored_not_chain_based():
    ordered = sort_weighted_candidates(
        [
...
def test_lower_fatigue_can_overtake_slightly_higher_score_within_group():
    ordered = sort_weighted_candidates(
        [
...
def test_cross_group_order_remains_score_driven_after_local_reordering():
    ordered = sort_weighted_candidates(
        [
