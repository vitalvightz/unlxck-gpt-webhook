...
PROTECTED_REBUILT_NAMES = [
    "Bilateral MMA Kick Flow",
    "Cage-Space Kick Flow",
    "Cage-Space Kick Rounds",
    ...
    "Intercept-and-Frame Kick Burst",
    ...
    "Kick-Level-Change Ready Reset",
    "Kick-or-Defend Decision Rounds",
    "Kick-Reposition Rounds",
    "Kick-Step Pressure Rounds",
    "Kick-and-Exit Burst",
    "Kick-to-Pressure Flow",
    "Low-Kick Repeatability",
    "MMA Kick Recoil Flow",
