...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/brand/unlxck-one-angle-48.png", sizes: "16x16", type: "image/png" },
      { url: "/brand/unlxck-one-angle-48.png", sizes: "32x32", type: "image/png" },
      { url: "/brand/unlxck-one-angle-48.png", sizes: "192x192", type: "image/png" },
    ],
    apple: [{ url: "/brand/unlxck-one-angle-48.png", sizes: "180x180", type: "image/png" }],
  },
  appleWebApp: {
    capable: true,
    title: "UNLXCK",
