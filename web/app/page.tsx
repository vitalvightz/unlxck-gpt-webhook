      ...
      <>
        ...
        <section className="panel overview-secondary athlete-motion-slot athlete-motion-status">
          ...
          <div className="overview-operational-strip" aria-label={openOngoing ? appText("text_69801072c634") : appText("text_7469690d23b2")}>
            <div className="overview-operational-item"><span className="overview-operational-label">{appText("text_fa8ed0bdabdd")}</span><span className="overview-operational-value">{String(activePlan.name || appText("text_637ae3d9e272"))}</span></div>
            <div className="overview-operational-item"><span className="overview-operational-label">{openOngoing ? appText("text_518653530449") : appText("text_d6594338fc6d")}</span><span className="overview-operational-value">{openOngoing ? appText("text_fb7f5a8dae6b") : campDay || appText("text_4895f73177ab")}</span></div>
            <div className="overview-operational-item"><span className="overview-operational-label">{openOngoing ? appText("text_5e23ec6a300d") : appText("text_46342ec1eec9")}</span><span className="overview-operational-value">{openOngoing ? appText("text_a90620097624") : humanizeIfRawEnum(activePlan.phase) || appText("text_4895f73177ab")}</span></div>
